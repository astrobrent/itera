...
; NAME:
;
;   ITERA_COLORBAR (NOTE that this is an ALTERED copy of David Fanning's
;   "COLOBAR" routine, with the name changed to distinguish it)
;
; PURPOSE:
;
...
;       ITERA_COLORBAR, NCOLORS=100, POSITION=[0.15, 0.85, 0.95, 0.90]
;
...
;------------------------------------------------------------------------------------------
;       04/07/08. changed vertical option to give the title on YAXIS
;       Brent Groves
;-
;
;###########################################################################
...
PRO ITERA_COLORBAR, BOTTOM=bottom, CHARSIZE=charsize, COLOR=color, DIVISIONS=divisions, $
